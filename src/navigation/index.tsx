        ...
        tabBarIcon: ({ focused }) => {
          return (
            <View
              ...
              />
              <Text options={focused ? selected : notSelected}>Blog</Text>
            </View>
          );
        },
      },
      ...
      navigationOptions: {
        tabBarIcon: ({ focused }) => (
          <View
            ...
            />
            <Text options={focused ? selected : notSelected}>Home</Text>
          </View>
        ),
      },
    },
        ...
        tabBarIcon: ({ focused }) => {
          return (
            <View
              ...
              />
              <Text options={focused ? selected : notSelected}>Profile</Text>
            </View>
          );
        },
      },
