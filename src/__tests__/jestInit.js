...
jest.mock("react-navigation-stack", () => {
    return {
        createStackNavigator: jest.fn().mockImplementation(nav => {
            return {
                router: {
                    getStateForAction: jest.fn().mockImplementation(component => component)
                }
            };
        }), 
    }
  ...
  jest.mock("react-native-twilio-video-webrtc", () => {
    return {
        TwilioVideo: (Component) => {
            return [
                Component.connect = jest.fn().mockImplementation(component => component),
                Component.disconnect = jest.fn().mockImplementation(component => component),
                Component.setLocalAudioEnabled = jest.fn().mockImplementation(component => component),
                Component.setLocalVideoEnabled = jest.fn().mockImplementation(component => component),
                Component.toggleSoundSetup = jest.fn().mockImplementation(component => component),
                Component.flipCamera = jest.fn().mockImplementation(component => component),
                Component.setRemoteAudioPlayback = jest.fn().mockImplementation(component => component),
                Component.getStats = jest.fn().mockImplementation(component => component),
                Component.onRoomDidConnect = jest.fn().mockImplementation(component => component),
                Component.onRoomDidFailToConnect = jest.fn().mockImplementation(component => component),
                Component.onParticipantAddedVideoTrack = jest.fn().mockImplementation(component => component),
                Component.onParticipantRemovedVideoTrack = jest.fn().mockImplementation(component => component),
            ]
        },
