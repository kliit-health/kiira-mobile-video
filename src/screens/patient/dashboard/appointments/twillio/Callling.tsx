...
const VideoCallScreen = ({ navigation }) => {
    ...
    const _onPauseButtonPress = () => {
        twilioVideo.current
            ...
            .then(isEnabled =>
                dispatch(
                    setCallConfig({ ...callConfig, isVideoEnabled: isEnabled }),
                ),
            );
    };
    ...
    const _onMuteButtonPress = () => {
        twilioVideo.current
            ...
            .then(isEnabled =>
                dispatch(
                    setCallConfig({ ...callConfig, isAudioEnabled: isEnabled }),
                ),
            );
    };
    ...
    return (
        <View style={styles.callContainer}>
            ...
            <TwilioVideo
                ...
                onRoomDidConnect={() => {
                    dispatch(
                        setCallConfig({ ...callConfig, status: 'connected' }),
                    );
                }}
                onRoomDidDisconnect={() => {
                    navigation.navigate('VisitEnd');
