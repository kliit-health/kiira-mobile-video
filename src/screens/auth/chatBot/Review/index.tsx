      ...
      <View style={styles.rowContainer}>
        ...
        <View style={{ width: 100 }}>
          ...
          {typeof sexuality === null || !sexuality ? (
            ...
            <Text style={styles.value}>{sexuality.value || ''}</Text>
          )}
        </View>
        ...
        <View style={{ width: 100 }}>
          ...
          {typeof insurance === null || !insurance ? (
            ...
            <Text style={styles.value}>{insurance.value || ''}</Text>
          )}
        </View>
          ...
          <Fragment>
            <View style={{ width: 100 }}>
              ...
              {typeof zipcode === null || !zipcode ? (
                ...
                <Text style={styles.plan}>{zipcode.value || ''}</Text>
              )}
            </View>
            ...
            <View style={{ width: 100 }}>
              ...
              {typeof housingSecure === null || !housingSecure ? (
                ...
                <Text style={styles.plan}>{housingSecure.message || ''}</Text>
              )}
            </View>
            ...
            <View>
              ...
              {typeof foodSecure === null || !foodSecure ? (
                ...
                <Text style={styles.plan}>{foodSecure.message || ''}</Text>
              )}
            </View>
            ...
            <View style={{ width: 100 }}>
              ...
              {typeof enrollment === null || !enrollment ? (
                ...
                <Text style={styles.plan}>{enrollment.value || ''}</Text>
              )}
            </View>

            <View>
              <Text style={styles.category}>Household Income:</Text>
              {typeof income === null || !income ? (
                <Text> </Text>
              ) : (
                <Text style={styles.plan}>{income.value || ''}</Text>
              )}
            </View>

            <View>
              <Text style={styles.category}>Race / Ethnicity:</Text>
              {typeof ethnicity === null || !ethnicity ? (
                <Text> </Text>
              ) : (
                <Text style={styles.plan}>{ethnicity.value || ''}</Text>
              )}
            </View>
          </Fragment>
        )}
