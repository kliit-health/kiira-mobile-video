  ...
  return (
    <View style={styles.showSheduleContainer}>
      ...
      <View style={styles.dayContainer}>
        <Text style={{ alignSelf: 'flex-start' }}>Select Appointment Date</Text>
            ...
            renderItem={({ item }) => {
              ...
              return (
                <View style={styles.date}>
                  <Text
                    style={
                      day === item.date ? styles.dateSelect : { color: 'black' }
                    }
                  >
                    {item.month}
                  </Text>
        ...
        <Conditional if={appointments.current}>
          ...
          >
            <Text style={styles.subHeader}>Select Appointment Time</Text>
          </View>
          <View style={styles.appointmentTimesContainer}>
            ...
            >
              <Conditional if={!appointments.current.length && loading}>
