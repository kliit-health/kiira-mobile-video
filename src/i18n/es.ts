export default {
  ...
  medicalConditions: {
    ...
    noMedicalConditions:
      'Spanish You have no conditions or procedures on record with Kiira',
  },
  insurance: {
  ...
  login: {
    ...
    MemberHelp:
      'Spanish Awesome!! If you are a member, you will receive an email to set your password shortly. If you’re not,  you need to select a plan to get started.',
    ...
    UseSameEmail:
      'Spanish Please use the same email address you used when you became a member.',
    OrganizationPlan:
      'Spanish If you are part of an organization sponsored plan i.e school or employer plan please use the email associated with your organization. example. _____.edu',
  },
  welcomeKiira: {
    welcomeKiira: ' Spanish Welcome to Kiira',
    oneStopTitle:
      'Spanish Your one stop shop for care. On the Kiira app you can:',
    getVirtualAppointmentsInfo:
      'Spanish Get virtual appointments, prescriptions, health resources, and answers to health questions via chat within 24 hours.',
    accessPersonalizedTeamInfo:
      "Spanish Access a personalized team of health providers for women's health, mental health, and primary care on-demand.",
    takeKiiraEveryWhereInfo:
      'Spanish Take Kiira with you everywhere you go and get answers specific to every stage of your life.',
  ...
  expertChats: {
    ...
    chats: 'Spanish Chats',
    patientName: 'Spanish Patient Name',
    noQuestions: 'Spanish You have no open chats.',
    subject: 'Spanish Subject',
