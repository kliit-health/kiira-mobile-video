  ...
  return (
    <Screen>
      ...
      {type !== controlType.CompleteType && (
        <Text options={[styles.numberStyle]}>
          {queryIndex + 1 + ' of ' + (healthIntakeQuerying.length - 1)}
        </Text>
      )}
      ...
      {type !== controlType.CompleteType && (
        <View
          ...
          <Text options={[styles.queryTextStyle]}>
            {healthIntakeQuerying[queryIndex].name}
          </Text>
        </View>
      )}
      {type === controlType.CompleteType && (
