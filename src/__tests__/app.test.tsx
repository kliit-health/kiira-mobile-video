...
describe('Testing my BillingAndInsurance', () => {
  ...
  test('canConfirm', () => {
    ...
    expect(
      canConfirm('&last', 'last', '333-333-3333', '333-333-3333', 'Mother'),
    ).toBeFalsy();
    expect(
      canConfirm('first&', 'last', '333-333-3333', '333-333-3333', 'Mother'),
    ).toBeFalsy();
    expect(
      canConfirm('first', 'last', '333-333-333', '333-33-3333', 'Mother'),
    ).toBeFalsy();
    expect(
      canConfirm('first', 'last', '333-333-333', '333-33-3333', ''),
    ).toBeFalsy();
  });
});
...
describe('Testing Appointment and Patient for 181', () => {
  ...
  const PatientDetailsTree = renderer.create(
    <PatientDetails visit patientInfo />,
  );
  test('patientDetails', () => {
...
describe('Testing Active Chat for 178', () => {
  ...
  const ChatExpertTree = renderer.create(
    <ChatExpert
      path
      setState
      flatList
