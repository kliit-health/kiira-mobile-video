...
export default {
  ...
  medicalConditions: {
    ...
    noMedicalConditions:
      'You have no conditions or procedures on record with Kiira',
  },
  insurance: {
    title: 'Insurance',
    save: 'Save',
  ...
  login: {
    ...
    MemberHelp:
      'Awesome!! If you are a member, you will receive an email to set your password shortly. If you’re not,  you need to select a plan to get started.',
  ...
  appointments: {
    ...
    notify:
      "We'll notifiy you about upcoming appointments, new messages, and more",
