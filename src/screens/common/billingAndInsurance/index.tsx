...
const BillingAndInsurance = ({ navigation }) => {
  ...
  const [memberId, setMemberId] = useState(
    user.profileInfo && user.profileInfo.insurancePlan
      ? user.profileInfo.insurancePlan
      : '',
  );
  const [billDate, setBillDate] = useState(
    user.profileInfo && user.profileInfo.billDate
      ? user.profileInfo.billDate
      : new Date(),
  );
      ...
      {!showEdit && (
        <View style={styles.inputTextParentContainerStyle}>
          <View style={styles.inputTextContainerStyle}>
            ...
            <View
              style={
                insurance ? styles.inputTypeStyle : styles.inputEmptyTypeStyle
              }>
              <Text
                style={insurance ? styles.textStyle : styles.textEmptyStyle}>
                {insurance
                  ? insurance
                  : lang.billingAndInsurance.insuranceCompany}
              </Text>
            </View>
          </View>
          ...
          <View style={styles.inputTextContainerStyle}>
            ...
            <View
              style={
                memberId ? styles.inputTypeStyle : styles.inputEmptyTypeStyle
              }>
          ...
          {false ? (
            <View style={styles.pastBillsContainerStyle}>
              <Text style={styles.pastBillStyle}>
                {lang.billingAndInsurance.pastBills}
              </Text>
            ...
            <View style={styles.pastBillsContainerStyle}>
              ...
              <Text style={styles.noBillStyle}>
                {lang.billingAndInsurance.noBills}
              </Text>
            </View>
          )}
        </View>
