        ...
        <Fragment>
            <SectionList
                ...
                sections={getSections(
                    visits.filter(
                        visit => visit.expert.uid === expertDetails.uid,
                    ),
                )}
            ...
            <View style={itemFutureStyles.timeContainer}>
                {formatTime(time, duration).map(({ primary, secondary }) => (
                    <View key={primary} style={itemFutureStyles.timeItem}>
                        <Text style={itemFutureStyles.primaryText}>
                            {primary}
                        </Text>
                        <Text style={itemFutureStyles.secondaryText}>
                            {secondary}
                        </Text>
                    </View>
                ))}
