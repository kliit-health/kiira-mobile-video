      ...
      <ScrollView bounces={false} style={styles.root}>
        <View style={styles.card}>
          ...
          <View style={styles.textContainer}>
            <Text style={styles.detailsTitle}>{`${patientName}`}</Text>
            <Text style={styles.detailsDescription}>
              {`${patient.firstName} ${patient.lastName}`}
            </Text>
          </View>
          <View style={styles.textContainer}>
            <Text style={styles.detailsTitle}>{`${dateAndTime}`}</Text>
            <Text style={styles.detailsDescription}>
          ...
          <View style={styles.textContainer}>
            ...
            <Text style={styles.detailsDescription}>{visit.locked}</Text>
          </View>
        </View>
        <View style={styles.card}>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.detailsDescription}>{visit.assessment}</Text>
        </View>
        <View style={styles.card}>
          <Text style={styles.sectionTitle}>{afterVisitSummary}</Text>
          <Text style={styles.detailsDescription}>{visit.summary}</Text>
        </View>
      </ScrollView>
    </Container>
  );
