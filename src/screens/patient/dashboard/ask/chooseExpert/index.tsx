...
class ChooseExpert extends Component {
    ...
    public props: any;
    public setState: any;
    public getExperts: any;
    public question: any;
    public clearState: any;
    public staticImages: any;
    public navigation: any;
    public expertData: any;
    public lang: any;
    public showEditQuestionModal: any;
    public setQuestionText: any;
    public showFilterModal: any;
    public genderItemsArr: any;
                        ...
                        <TouchableOpacity
                            onPress={() => {
                                navigation.navigate(
                                    ...
                                    {
                                        isFrom: Constant.App.screenNames
                                            .ChooseExpert,
                                        uid: item.uid,
                                    },
                                );
                        ...
                        >
                            <View style={styles.expertInfoParentContainerStyle}>
                                ...
                                {item.isOnline ? (
                                    <View
                                        style={{
                                            ...
                                            borderRadius: 8,
                                            backgroundColor:
                                                Constant.App.colors.greenColor,
                                            position: 'absolute',
                                        }}
                                    />
                                ) : (
                                ...
                                <View style={styles.expertInfoContainerStyle}>
                                    <CustomText
                                        style={styles.expertNameTextBoldStyle}
                                    >
                                        {`${item.profileInfo.firstName} ${item.profileInfo.lastName}`}
                                    </CustomText>
                                    <CustomText
                                        style={
                                            styles.expertInfoProfessionTextStyle
                                        }
                                    >
                                    ...
                                    <CustomText
                                        style={
                                            styles.expertProfessionLoctionBoldStyle
                                        }
                                    >
            ...
            >
                <View style={styles.editQuestionModalParentContainerStyle}>
                    <View style={styles.editQuestionModalInnerContainerStyle}>
                        <View
                            style={
                                styles.editQuestionModalInputTextContainerStyle
                            }
                        >
                            <InputText
                                maxHeight={100}
                                ...
                                placeholderTextColor={
                                    Constant.App.colors.lightGrey
                                }
                            />
                        </View>
                        <View
                            style={styles.editQuestionModalButtonContainerStyle}
                        >
                            <CustomButton
                                buttonStyle={
                                    styles.cancelBtnEditQuestionModalContainerStyle
                                }
                                textStyle={
                                    styles.cancelBtnEditQuestionModalTextStyle
                                }
                            ...
                            <CustomButton
                                ...
                                buttonStyle={
                                    styles.saveBtnEditQuestionModalContainerStyle
                                }
                                textStyle={
                                    styles.saveBtnEditQuestionModalTextStyle
                                }
            ...
            >
                <View style={styles.filterModalParentContainerStyle}>
                    <View style={styles.filterModalTitleContainerStyle}>
                        ...
                        <TouchableOpacity
                            ...
                            onPress={() => {
                                ...
                                const filterParams = {
                                    tableName:
                                        Constant.App.firebaseTableNames.users,
                                    roleKey:
                                        Constant.App.firebaseTableKeyValuesNames
                                            .expertsConditionKey,
                                    roleValue:
                                ...
                                professionData.forEach(element => {
                                    if (element.selected) {
                                        isFilerSelected = true;
                                        filterParams.professionValue =
                                            element.fullName;
                                        filterParams.professions.push(
                                            element.fullName,
                                        );
                                    }
                                });
                                ...
                                if (isFilerSelected) {
                                    ...
                                    const params = {
                                        expertsParams: {
                                            tableName:
                                                Constant.App.firebaseTableNames
                                                    .users,
                                            roleKey:
                                                Constant.App
                    ...
                    <View style={styles.filterModalGenderParentContainerStyle}>
                        <CustomText
                            style={styles.filterModalGenderTitleTextStyle}
                        >
                                ...
                                onPress={() => {
                                    genderItemsArr.forEach((element, index) => {
                                        if (
                                            ...
                                            genderItemsArr[index].selected =
                                                false;
                                        }
                                    });
                                    genderItemsArr[key].selected =
                                        genderItemsArr[key].selected
                                            ? false
                                            : true;
                                    this.setState({
                                        genderItemsArr: Object.assign(
                                            [],
                                            [],
                                            genderItemsArr,
                                        ),
                            ...
                            >
                                ...
                                >
                                    <Image
                                        ...
                                        style={
                                            styles.filterModalItemChecboxIconStyle
                                        }
                                    />
                                    <CustomText
                                        style={styles.filterModalItemTextStyle}
                                    >
                                        {item.title}
                                    </CustomText>
                                </View>
                    ...
                    <View
                        style={styles.filterModalProfessionParentContainerStyle}
                    >
                        <CustomText
                            style={styles.filterModalProfessionTitleTextStyle}
                        >
                        ...
                        {professionData.map((item, key) => (
                            <TouchableOpacity
                                ...
                                onPress={() => {
                                    ...
                                    //   }
                                    // });
                                    professionData[key].selected =
                                        professionData[key].selected
                                            ? false
                                            : true;
                                    this.setState({
                                        professionData: Object.assign(
                                            [],
                                            [],
                                            professionData,
                                        ),
                    ...
                    <View style={styles.filterModalLangParentContainerStyle}>
                        <CustomText
                            style={styles.filterModalLangTitleTextStyle}
                        >
                        ...
                        {languagesData.map((item, key) => (
                            <TouchableOpacity
                                key={key}
                                onPress={() => {
                                    languagesData[key].selected = languagesData[
                                        key
                                    ].selected
                                        ? false
                                        : true;
                                    this.setState({
                                        languagesData: Object.assign(
                                            [],
                                            [],
                                            languagesData,
                                        ),
