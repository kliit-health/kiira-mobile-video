    ...
    fetchData() {
        ...
        const params = {
            questionParams: {
                ...
                key: Constant.App.firebaseTableKeyValuesNames
                    .questionConditionKey,
                value: false,
                userConditionKey:
                    Constant.App.firebaseTableKeyValuesNames
                        .questionUserConditionKey,
            },
            expertsParams: {
                tableName: Constant.App.firebaseTableNames.users,
                key: Constant.App.firebaseTableKeyValuesNames
                    .expertsConditionKey,
                value: Constant.App.firebaseTableKeyValuesNames
                        ...
                        return (
                            ...
                            >
                                ...
                                >
                                    ...
                                    <CustomText
                                        style={styles.expertProfTextStyle}
                                    >
                ...
                >
                    ...
                    <View style={styles.expertInfoContainerStyle}>
                        <FastImage
                            ...
                            source={{
                                uri: questionData.expertInfo.profileInfo
                                    .profileImageUrl
                                    ? questionData.expertInfo.profileInfo
                                          .profileImageUrl
                                    : '',
                            }}
                            activeOpacity={0.7}
