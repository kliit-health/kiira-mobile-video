    ...
    return (
      <TouchableOpacity onPress={() => handleSelection(expert)}>
        <Kiira.Row options={[white_bg, sm_pad_v, pad_vertical]}>
          ...
          />
          <Kiira.Column>
            <Kiira.Text options={[pad_h, xLarge]}>{expertName}</Kiira.Text>
        ...
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            ...
            <Text style={styles.subtitle}>
              We want to ensure that you are able to get the care you need.
              Please check your email for an update. You should receive a
              message shortly.
            </Text>
    ...
    <Kiira.Screen test="Book Screen" options={[white_bg]}>
      ...
      <Kiira.Column options={[white_bg, { flex: 2 }]}>
        ...
        <Kiira.Text
          ...
          Due to licensing, video visits are currently limited to covered
          locations.Please let us know if you would like an update on
