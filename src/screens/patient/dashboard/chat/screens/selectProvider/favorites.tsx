  ...
  return (
    <View style={styles.expertsContainer}>
      <FlatList
        ...
        renderItem={({ item }) => {
          const {
            profileInfo: { profileImageUrl, firstName, lastName, profession },
          } = item;
          return (
            <View style={styles.expertInfoContainer}>
              ...
              <View style={styles.expertInfo}>
                <Text options={[xLarge]}>{`${firstName} ${lastName}`}</Text>
                <Text options={[medium, gray_dark]}>{profession.fullName}</Text>
                <TouchableOpacity onPress={() => showProfileModal(item)}>
              ...
              <View>
                ...
                <TouchableOpacity
                  ...
                  <Image resizeMode="contain" source={icons.chatIcon} />
                </TouchableOpacity>
              </View>
            </View>
          );
