...
const Calendar = ({ navigation }) => {
  ...
  return (
    <Kiira.Screen>
              ...
              <Kiira.Button
                ...
                style={{
                  container: [
                    ...
                    pad_top_none,
                    { width: 65 },
                    moment(date.date).format('ll') === day ? blue_br : grey_br,
                  ],
                  title: [black],
                }}
                title={`${date.dow} \n\n ${date.day}`}
      ...
      <Kiira.Text options={[pad]}>{bookVisitText.message}</Kiira.Text>
      <View style={{ alignItems: 'center', justifyContent: 'center' }}>
        <FlatList
          ...
          data={
            appointments.appointments.current.error
              ? []
              ...
              <Kiira.Button
                ...
                style={{
                  container: [
                    ...
                    { width: 100 },
                    { margin: 20 },
                    time && current.date === time.date ? blue_br_sm : grey_br,
                  ],
                  title: [blue],
                }}
      ...
      <Kiira.Button
        ...
        style={{
          container: [
            ...
            {
              backgroundColor:
                !day || !time ? colors.disableButtonColor : colors.primaryBlue,
            },
          ],
          title: [],
        }}
