    ...
    <ScrollView style={{ backgroundColor: colors.white }}>
      <View>
        ...
        <Text style={styles.AdditionalInformationText}>
          Finish filling out your basic profile information to make things
          easier later on
        </Text>
      </View>
      <View style={{ margin: '6%' }}>
          ...
          onPress={() => {
            ...
            const payloadData = {
              userParams: {
                ...
                nickName: userProfileData.nickName
                  ...
                  : '',
                sexuality: userProfileAdditionalData.selectedSexuality
                  ? userProfileAdditionalData.selectedSexuality
                  : {},
                pharmacy: userProfileAdditionalData.selectedPharmacy.value
                  ? userProfileAdditionalData.selectedPharmacy.value
                  : '',
                pharmacyAddress: userProfileAdditionalData.pharmacyAddress
                  ? userProfileAdditionalData.pharmacyAddress
                  : '',
                pharmacyPhone: userProfileAdditionalData.pharmacyPhoneNumber
                  ? userProfileAdditionalData.pharmacyPhoneNumber
                  : '',
                insurance: userProfileAdditionalData.selectedInsurance
                  ? userProfileAdditionalData.selectedInsurance.value
                  : '',
                insurancePlan: userProfileAdditionalData.memberId
                  ? userProfileAdditionalData.memberId
                  : '',
                role: 'User',
                signUpDate: Date.now(),
            ...
            if (filename) {
              payloadData.imageParams = {
                file:
                  Platform.OS == 'ios' ? userProfileData.imageSrc : filePath,
                filename,
              };
            }
