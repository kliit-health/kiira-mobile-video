            ...
            <Column options={[justify_fs]}>
                <Row options={[white_bg, grey_br_b_md, grey_br_t_md]}>
                    ...
                    <Column options={[pad_h, white_bg, pad_v]}>
                        <Text
                            options={[xxLarge, regular]}
                        >{`${expert.firstName} ${expert.lastName}`}</Text>
                        <Text options={[large, medium]}>{`Seen on ${moment(
                            time,
                        ).format('ll')}`}</Text>
                    </Column>
                </Row>
                <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    <Column options={[justify_fs, grey_br_b_md]}>
                        <Row options={[white_bg]}>
                            ...
                            <Column options={[pad_h, white_bg, pad_v]}>
                                ...
                                >{`Seen on ${moment(time).format('ll')}`}</Text>
                            </Column>
                        </Row>
                    </Column>
                    ...
                    <Column options={[justify_fs, grey_br_b_md]}>
                        <Text options={[white_bg, pad, xLarge]}>
                            This is a placeholder for the rest of the page on
                            the visit summary screen inside the past
                            appointments
                        </Text>
                    </Column>
                </ScrollView>
