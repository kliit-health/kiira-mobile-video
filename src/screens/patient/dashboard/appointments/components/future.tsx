...
const Future = ({ test, visit, date, navigation }) => {
    ...
    return (
      <View style={styles.appointmentModify}>
        <CustomButton
          ...
          onPress={() =>
            sameDay ? handleSameDay() : dispatch(cancelAppointment({ data }))
          }
          text="Cancel"
        />
        <CustomButton
          ...
          buttonStyle={styles.appointmentButtonContainer}
          textStyle={styles.appointmentButtonText}
          onPress={() => (sameDay ? handleSameDay() : handleReschedule())}
          text="Reschedule"
        />
      </View>
    );
  ...
  return (
    <Column
      options={[white_bg, pad_h, pad_v_md, radius_md, hide_overflow, grey_br]}>
      <VisitTime />
      <ExpertDetails />
      <ModifyVisit />
      <VisitDetails />
      ...
      <CustomButton
        disabled={!sameDay}
        buttonStyle={sameDay ? styles.active : [styles.active, styles.disabled]}
