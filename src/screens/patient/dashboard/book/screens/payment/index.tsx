    ...
    return (
      <Kiira.Column options={[card]}>
        <Kiira.Text options={[card_title]}>
          {moment(appointments.visit.time.date).format('ddd MMM Do h:mm a')}
        </Kiira.Text>
        <Kiira.Row options={[pad_h, pad_v]}>
          <FastImage
            style={[image_md]}
            source={{
              uri: appointments.visit.expert.profileInfo.profileImageUrl,
            }}
          />
          <Kiira.Column options={[pad_h, space_around]}>
            ...
            <Kiira.Text options={[gray_dark]}>
              {appointments.visit.expert.profileInfo.profession.shortName}
            </Kiira.Text>
          </Kiira.Column>
        </Kiira.Row>
      </Kiira.Column>
