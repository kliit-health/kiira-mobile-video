...
const Ratings = ({
  ...
  const styles = {
    ...
    starContainer: [defaultStyles.starContainer, customStyles.starContainer],
  };
  ...
  return (
    <Fragment>
      {multistar ? (
          ...
          {getStars(value, numberOfStars).map(({color}) => {
            ...
            return (
              <View key={key} style={styles.starContainer}>
                <Star width={size.width} heigth={size.heigth} color={color} />
              </View>
            );
          })}
        </View>
        ...
        <View style={styles.root}>
          <Star width={size.width} heigth={size.heigth} color={colors.yellow} />
