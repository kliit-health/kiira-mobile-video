    ...
    >
      {showShedule && (
        <>
          ...
          >
            ...
            >
              {showShedule && appointmentData.appointments.current.length ? (
                appointmentData.appointments.current.map((item, i) => {
      ...
      {!dates.length ? (
        ...
        >
          <Text
            style={
              day && time ? styles.noSelectedTextStyle : styles.noTextStyle
            }
          >
